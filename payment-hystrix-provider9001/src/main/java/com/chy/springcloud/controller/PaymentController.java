...
public class PaymentController {
  ...
  public CommonResult timeout(@PathVariable String id) {
    Payment payment = paymentService.timeout(id);
    log.info("结果：" + payment);
    if (payment != null) {
      return new CommonResult(200, "查询成功serverPort: " + serverPort, payment);
    }
    return new CommonResult(444, "访问超时/(ㄒoㄒ)/~~ " + serverPort, null);
  }
  ...
  public String paymentCircuitBreaker(@PathVariable(value = "id", required = false) String id) {
